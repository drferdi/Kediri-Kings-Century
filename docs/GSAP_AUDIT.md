...
| Content model | 1 prologue + 1 inscription interlude + 9 act headers + 26 scenes + 1 finale. Choreography is a CMS *intent* (`choreographyKey`); the code owns every selector, tween, duration, ease |
...
| *(none — static document)* | panji-story-left-kediri | 1 |
