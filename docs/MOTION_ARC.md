...
| --------------------------------------------- | ----------------------------------------------------------- | ---------------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Quiet opening**                             | Prologue, 879, 921, inscription interlude                   | Wonder, patience       | 1–3       | Kediri hadir langsung; dolly scroll membawa kota ke Brantas, garis air memipih menjadi tembaga dan portal 879. Setelah nama Kadhiri diperkenalkan pada 921, evidence cards wipe in under the reader's own scroll |
...
5. **Opening has no forced clock.** Gambar HD Kediri hadir pada first paint;
   dolly dan transformasi procedural air → tembaga hanya bergerak di bawah
   tangan pembaca. Reduced motion mempertahankan gambar dan seluruh naskah dalam
   komposisi statis.
6. **Intensity never rises twice in a row without a rest.** Each climax is
