 ...
 * Pin distances are svh-based and stable, but act-header media and late fonts
 * can change document height after the first measurement. `ActHeaderReveal`
 * documented the symptom in the wild
